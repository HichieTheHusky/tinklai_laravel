                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('createPreke') }}">
                            ...
                            <div class="form-group">
                                <label for="usecase">Naudojimo paskirtis</label>
                                <input type="text" class="form-control" name="usecase" id="usecase" aria-describedby="emailHelp" placeholder="Įveskite naudojimo paskirti">
                                @error('type')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <input type="hidden" id="kategory" name="kategory" value={{'Base'}}>
